 ...
 * @api public
 */
function stringJSON2YAML (doc, compress = false) {
  ...
  return yaml.safeDump(obj, compress ? {'flowLevel': 0} : undefined)
}
 ...
 * @api public
 */
function stringYAML2JSON (doc, compress = false) {
  ...
  return JSON.stringify(obj, undefined, compress ? undefined : 2)
}
 ...
 * @api public
 */
function stringJSON2JSON (doc, compress = false) {
  if (!doc || (typeof doc !== 'string' && typeof doc !== 'object')) {
    throw new TypeError('Argument must be a string or object, and not empty: ' + doc)
  }
 ...
 * @api public
 */
function stringYAML2YAML (doc, compress = false) {
  if (!doc || typeof doc !== 'string') {
    throw new TypeError('Argument must be a string or object, and not empty: ' + doc)
  }
